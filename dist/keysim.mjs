 ...
 */
function Keystroke(modifiers, keyCode, key, code) {
  ...
  _createClass(Keyboard, [{
    ...
    value: function dispatchModifierStateTransition(target, fromModifierState, toModifierState) {
      ...
      if (includeKeyUp && didHaveCtrl === true && willHaveCtrl === false) {
        ...
        target.dispatchEvent(this.createEventFromKeystroke('keyup', new Keystroke(currentModifierState, this._actionKeyCodeMap.CTRL, VALUE_CONTROL, CODE_CONTROL_LEFT), target));
      }
      ...
      if (includeKeyDown && didHaveCtrl === false && willHaveCtrl === true) {
        // Press the ctrl key.
        currentModifierState |= CTRL;
        target.dispatchEvent(this.createEventFromKeystroke('keydown', new Keystroke(currentModifierState, this._actionKeyCodeMap.CTRL, VALUE_CONTROL, CODE_CONTROL_LEFT), target));
      }
